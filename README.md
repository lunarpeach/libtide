...
Miscellaneous C++ headers that have seen some use in my hobby projects.
...
C++17 support.  I'm building with `-std=c++17` for now, but intend to move to
`-std=c++20` in the future.